#!/usr/bin/env python3
"""Import SigmaHQ threat-hunting rules into hunt/<category>/sigma/, and write tracker/sigma_tracker.md.
...
TRACKER = os.path.join(ROOT, "tracker", "sigma_tracker.md")
...
def main() -> int:
    ...
    for folder, name, meaning in CATEGORIES:
        ...
        with open(os.path.join(d, "README.md"), "w") as fh:
            ...
            fh.write("See [stats.md](../../stats.md) and [sigma_tracker.md](../../tracker/sigma_tracker.md). "
